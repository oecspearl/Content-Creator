...
*   **OAuth Providers**: Google OAuth 2.0 and Microsoft OAuth 2.0 (both via Passport.js with passport-google-oauth20 and passport-azure-ad respectively) for user authentication.
